...
public class HomeManager : MonoBehaviour
{
    ...
    [Header("Popups")]
    [SerializeField] private GameObject level1Warning;
    [SerializeField] private GameObject level2Warning;
    ...
    {
        if (gameNo.Equals(2) && Container.game1Point < 16)
        {
            level1Warning.SetActive(true);
            return;
        }
        else if (gameNo.Equals(3) && Container.game2Point < 18)
        {
        ...
        Container.life = 3;
        Container.showGame3Intro = true;
        Container.showAds = gameNo.Equals(2) ? false : true;
